...
def _truncate_segments(segments, max_num_tokens, rng=None):
    """
...
class MNLIDatasetPT(PTDataset):
    ...
    def __init__(self, tokenizer, data_path, max_length):
        ...
        data_encode = tokenizer(sentence1,
                                sentence2,
                                max_length)

        self.input_ids = data_encode['input_ids']
        self.type_ids = data_encode['token_type_ids']
        self.input_mask = data_encode['attention_mask']
